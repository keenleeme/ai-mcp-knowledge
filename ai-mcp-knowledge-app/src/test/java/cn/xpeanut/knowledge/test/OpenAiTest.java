...
public class OpenAiTest {
    ...
    public void test_call() {
        ChatResponse chatResponse = openAiChatModel.call(new Prompt("1+1", OpenAiChatOptions.builder()
                .model("gpt-4o").build()));
    ...
    public void test_call_images() {
        ...
        ChatResponse chatResponse = openAiChatModel.call(new Prompt(userMessage, OpenAiChatOptions.builder().model("gpt-4o").build()));
    ...
    public void test_call_stream() throws InterruptedException {
        ...
        Flux<ChatResponse> stream = openAiChatModel.stream(new Prompt("1+1", OpenAiChatOptions.builder().model("gpt-4o").build()));
        stream.subscribe(
                chatResponse -> {
    ...
    public void test_rag_chat() {
        ...
        ChatResponse chatResponse = openAiChatModel.call(new Prompt(promptMessages, OpenAiChatOptions.builder().model("gpt-4o").build()));
